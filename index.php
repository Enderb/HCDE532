<?php include('includes/header.php'); ?>
           ...
           <div class="flexslider">
               <ul class="slides">
                   <li><img src="images/slide1.jpg" width="940" height="400" alt="Image One"/></li>
                   <li><img src="images/slide2.jpg" width="940" height="400" alt="Image Two"/></li>
                   <li><img src="images/slide3.jpg" width="940" height="400" alt="Image Three"/></li>
                </ul>
            </div>
           <!-- End Flex Slider -->
